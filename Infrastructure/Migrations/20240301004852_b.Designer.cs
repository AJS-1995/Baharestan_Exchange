...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domin.ManagementPresonsDomin.LivelihoodDomin.Livelihood", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Tbl_Livelihoods", (string)null);
                });

            modelBuilder.Entity("Domin.ManagementPresonsDomin.LivelihoodMonthDomin.LivelihoodMonth", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("LivelihoodId");

                    b.ToTable("Tbl_LivelihoodMonths", (string)null);
                });
            ...
            modelBuilder.Entity("Domin.ManagementPresonsDomin.LivelihoodDomin.Livelihood", b =>
                {
                    b.HasOne("Domin.AgenciesDomin.Agencies", "Agenciess")
                        .WithMany("Livelihoods")
                        .HasForeignKey("AgenciesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domin.MoneyDomin.Money", "Moneys")
                        .WithMany("Livelihoods")
            ...
            modelBuilder.Entity("Domin.ManagementPresonsDomin.LivelihoodMonthDomin.LivelihoodMonth", b =>
                {
                    b.HasOne("Domin.AgenciesDomin.Agencies", "Agenciess")
                        .WithMany("LivelihoodMonths")
                        .HasForeignKey("AgenciesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domin.ManagementPresonsDomin.LivelihoodDomin.Livelihood", "Livelihood")
                        .WithMany("LivelihoodMonths")
                        .HasForeignKey("LivelihoodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Agenciess");

                    b.Navigation("Livelihood");
                });
            ...
            modelBuilder.Entity("Domin.ManagementPresonsDomin.PersonsReceiptDomin.PersonsReceipt", b =>
                {
                    ...
                    b.HasOne("Domin.SafeBoxDomin.SafeBox", "SafeBoxs")
                        .WithMany("PersonsReceipts")
            ...
            modelBuilder.Entity("Domin.AgenciesDomin.Agencies", b =>
                {
                    b.Navigation("LivelihoodMonths");

                    b.Navigation("Livelihoods");
