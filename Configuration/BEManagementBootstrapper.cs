...
using Infrastructure.Repository.PersonsUsersRepository;
...
namespace Configuration
{
    public class BEManagementBootstrapper
    {
        public static void Configure(IServiceCollection services, string connectionString)
        {
            ...
            services.AddTransient<IPersonsUserApplication, PersonsUserApplication>();
            services.AddTransient<IPersonsUserRepository, PersonsUserRepository>();
